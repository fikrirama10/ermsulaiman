                    ...
                    <div class="w-lg-500px p-10">
                        ...
                        <form class="form w-100" novalidate="novalidate" id="kt_sign_in_form"
                            ...
                            <div class="text-center mb-11">
                                ...
                                <!--end::Title-->
                                <!--begin::Subtitle-->
                                <div class="text-gray-500 fw-semibold fs-6">Silahkan masukan email dan password anda
                                </div>
                                <!--end::Subtitle=-->
                            </div>
                            <!--begin::Heading-->
        ...
        <a href="../../demo1/dist/authentication/layouts/corporate/sign-up.html" class="link-primary">Sign up</a></div> -->
            ...
            <div class="d-flex flex-lg-row-fluid w-lg-50 bgi-size-cover bgi-position-center order-1 order-lg-2"
                ...
                <div class="d-flex flex-column flex-center py-7 py-lg-15 px-5 px-md-15 w-100">
                    ...
                    <!--end::Image-->
                    <!--begin::Title-->
                    <h1 class="d-none d-lg-block text-white fs-2qx fw-bolder text-center mb-7 shadow">Rekam Medis
                        Elektronik</h1>
                    <!--end::Title-->
                    <!--begin::Text-->
                    <div class="d-none d-lg-block text-white fs-base text-center">Sistem Informasi Rumah Sakit RSAU dr
                        Norman T Lubis</div>
