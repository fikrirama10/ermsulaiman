                ...
                <div class="card-body pt-9 pb-0 header-gradient rounded-top">
                                ...
                                <div class="d-flex flex-column">
                                    ...
                                    <div class="d-flex flex-wrap fw-semibold fs-6 mb-4 pe-2">
                                        <a href="#" class="d-flex align-items-center text-white text-opacity-75 text-hover-white me-5 mb-2">
                                            <i class="ki-outline ki-profile-circle fs-4 me-1 text-white text-opacity-75"></i> Kelola Data Dokter, Jadwal & Akun
                                        </a>
                                    </div>
                                </div>
                                <div class="d-flex flex-wrap gap-2">
                                    <button class="btn btn-sm btn-light btn-active-light-primary" onclick="syncAllUsers()">
                                        <i class="ki-outline ki-cloud-change fs-4 me-1"></i> Sinkron Akun Massal
                                    </button>
                                     <button class="btn btn-sm btn-white btn-color-gray-700 btn-primary shadow-sm" data-bs-toggle="modal" data-bs-target="#modalTambahDokter">
                    ...
                    <div class="d-flex overflow-auto h-55px">
                        <ul class="nav nav-stretch nav-line-tabs nav-line-tabs-2x border-transparent fs-5 fw-bold flex-nowrap">
                            <li class="nav-item">
                                <a class="nav-link text-white text-active-white border-active-white bg-opacity-10 active" href="#">Overview</a>
                            </li>
                        </ul>
                    </div>
                </div>
                ...
                <div class="card-header border-0 pt-6">
                    <div class="card-title">
                        <div class="d-flex align-items-center position-relative my-1">
                            ...
                            <input type="text" data-kt-dokter-table-filter="search" class="form-control form-control-solid w-250px ps-13" placeholder="Cari Dokter..." />
                        </div>
                    </div>
                            ...
                            <div class="menu menu-sub menu-sub-dropdown w-300px w-md-325px" data-kt-menu="true">
                                ...
                                <div class="px-7 py-5">
                                    <div class="mb-5">
                                        ...
                                        <select class="form-select form-select-solid" data-kt-select2="true" data-placeholder="Pilih Spesialis" data-allow-clear="true" id="filter_spesialis">
                                            <option></option>
                                    ...
                                    <div class="d-flex justify-content-end">
                                        <button type="reset" class="btn btn-light btn-active-light-primary fw-semibold me-2 px-6" data-kt-menu-dismiss="true" id="btn-reset-filter">Reset</button>
                                        <button type="submit" class="btn btn-primary fw-semibold px-6" data-kt-menu-dismiss="true" id="btn-apply-filter">Terapkan</button>
                                    </div>
                                </div>
                            </div>
                            <!-- Bulk Actions (Dropdown) -->
                             <div class="dropdown">
                                <button class="btn btn-light-warning dropdown-toggle" type="button" id="dropdownMenuButton1" data-bs-toggle="dropdown" aria-expanded="false">
                                    <i class="ki-outline ki-category fs-2"></i> Aksi Massal
                                </button>
                                <ul class="dropdown-menu" aria-labelledby="dropdownMenuButton1">
                                    <li><a class="dropdown-item text-success" href="#" onclick="bulkAction('activate')"><i class="ki-outline ki-check-circle me-2 text-success"></i>Aktifkan Terpilih</a></li>
                                    <li><a class="dropdown-item text-danger" href="#" onclick="bulkAction('deactivate')"><i class="ki-outline ki-cross-circle me-2 text-danger"></i>Nonaktifkan Terpilih</a></li>
                                </ul>
                            </div>
                        </div>
                    </div>
                            ...
                            <tr class="text-start text-muted fw-bold fs-7 text-uppercase gs-0">
                                <th class="w-10px pe-2">
                                    <div class="form-check form-check-sm form-check-custom form-check-solid me-3">
                                        <input class="form-check-input" type="checkbox" id="check-all-dokter" value="1" />
                                    </div>
                                </th>
                ...
                <div class="modal-body scroll-y px-10 px-lg-15 pt-0 pb-15">
                    ...
                    <div class="row g-9 mb-8">
                         <div class="col-md-6 fv-row">
                            ...
                            <input type="text" class="form-control form-control-solid" placeholder="Misal: D001" name="kode_dokter" id="kode_dokter" required />
                        </div>
                        <div class="col-md-6 fv-row">
                            <label class="required fs-6 fw-semibold mb-2">Nama Lengkap</label>
                            <input type="text" class="form-control form-control-solid" placeholder="Nama Dokter + Gelar" name="nama_dokter" id="nama_dokter" required />
                        </div>
                    </div>
                     ...
                     <div class="row g-9 mb-8">
                        <div class="col-md-6 fv-row">
                            ...
                            <select name="idspesialis" id="idspesialis" class="form-select form-select-solid" data-control="select2" data-hide-search="true" data-placeholder="Pilih Spesialis">
                        ...
                        <div class="col-md-6 fv-row">
                            ...
                            <select name="idpoli" id="idpoli" class="form-select form-select-solid" data-control="select2" data-hide-search="true" data-placeholder="Pilih Poli">
                     ...
                     <div class="row g-9 mb-8">
                        <div class="col-md-6 fv-row">
                             ...
                             <input type="text" name="sip" id="sip" class="form-control form-control-solid" placeholder="Nomor SIP" />
                        </div>
                         <div class="col-md-6 fv-row">
                    ...
                    <div id="user-account-section" class="bg-light-primary p-5 rounded mt-5 border border-dashed border-primary">
                         ...
                         <div class="mb-2 text-muted fs-7">Wajib diisi untuk dokter baru agar bisa login ke sistem.</div>
                          <div class="row g-9">
                            <div class="col-md-6 fv-row">
...
<script>
    ...
    $(function(){
        ...
        let table = $("#tbl-dokter").DataTable({
            ...
            columns: [
                { data: 'checkbox', orderable: false, searchable: false, className: 'align-middle ps-4' },
                { data: 'nama_dokter', render: function(data, type, row) {
                    return `
                ...
                { data: 'spesialis_name', render: function(data) {
                    return `<span class="badge badge-light-primary fw-bold px-4 py-3">${data}</span>`;
                }},
                { data: 'user_status', className: 'align-middle' },
                { data: 'status_badge', className: 'align-middle' },
        ...
        // Filters Apply
        $('#btn-apply-filter').click(function () { table.ajax.reload(); });
            ...
            $.ajax({
                ...
                error: function(xhr) {
                     ...
                     if(xhr.responseJSON && xhr.responseJSON.errors) {
                         errorMsg = Object.values(xhr.responseJSON.errors).map(val => val[0]).join('\n');
        ...
        window.editDokter = function(id) {
            $.get('{{ route("dokter.edit", ":id") }}'.replace(':id', id), function(data) {
                ...
                // Logic to handle User Account on Edit: Hide if exists or handle updating?
                // For simplicity as per original logic: hide create account section on edit
        ...
        window.toggleStatus = function(id) {
             $.post('{{ route("dokter.toggle", ":id") }}'.replace(':id', id), { _token: '{{ csrf_token() }}' }, function(response) {
                table.ajax.reload();
        ...
        // Reset Modal
        $('#modalTambahDokter').on('hidden.bs.modal', function() { resetModal(); });
    });
    ...
    window.syncAllUsers = function() {
        Swal.fire({
            ...
            if (result.isConfirmed) {
                $.ajax({
                    url: '{{ route("dokter.sync-all-users") }}', type: 'POST', data: { _token: '{{ csrf_token() }}' },
                    success: function(response) {
    ...
    window.bulkAction = function(action) {
        let selected = [];
        $('.dokter-checkbox:checked').each(function() { selected.push($(this).val()); });

        if (selected.length === 0) { Swal.fire('Pilih Data', 'Centang minimal satu dokter', 'warning'); return; }
        ...
        Swal.fire({
            ...
            confirmButtonText: 'Ya, Lakukan'
             ...
             if(res.isConfirmed) {
                 $.post('{{ route("dokter.bulk-toggle") }}', { _token: '{{ csrf_token() }}', ids: selected.join(','), action: action }, function(response) {
                    $('#tbl-dokter').DataTable().ajax.reload();
