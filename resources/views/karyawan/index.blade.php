                                ...
                                <div class="d-flex flex-column">
                                    ...
                                    <div class="d-flex flex-wrap fw-semibold fs-6 mb-4 pe-2">
                                        <a href="#" class="d-flex align-items-center text-white text-opacity-75 text-hover-white me-5 mb-2">
                                            <i class="ki-outline ki-profile-circle fs-4 me-1 text-white text-opacity-75"></i> Kelola Data Perawat, Bidan & Staff Lainnya
                                        </a>
                                    </div>
                                </div>
                                <div class="d-flex flex-wrap gap-2">
                                     <button class="btn btn-sm btn-white btn-color-gray-700 btn-primary shadow-sm" data-bs-toggle="modal" data-bs-target="#modalTambahKaryawan">
                ...
                <div class="card-header border-0 pt-6">
                    <div class="card-title">
                        <div class="d-flex align-items-center position-relative my-1">
                            ...
                            <input type="text" data-kt-karyawan-table-filter="search" class="form-control form-control-solid w-250px ps-13" placeholder="Cari Karyawan..." />
                        </div>
                    </div>
                            ...
                            <div class="menu menu-sub menu-sub-dropdown w-300px w-md-325px" data-kt-menu="true">
                                ...
                                <div class="px-7 py-5">
                                     <div class="mb-5">
                                        ...
                                        <select class="form-select form-select-solid" data-kt-select2="true" data-placeholder="Pilih Kategori" data-allow-clear="true" id="filter_kategori">
                                            <option></option>
                                    ...
                                    <div class="mb-5">
                                        ...
                                        <select class="form-select form-select-solid" data-kt-select2="true" data-placeholder="Pilih Bagian" data-allow-clear="true" id="filter_bagian">
                                            <option></option>
                                            @foreach($bagian as $b)
                            ...
                            <tr class="text-start text-muted fw-bold fs-7 text-uppercase gs-0">
                                <th class="w-10px pe-2">
                                    <div class="form-check form-check-sm form-check-custom form-check-solid me-3">
                                        <input class="form-check-input" type="checkbox" id="check-all-karyawan" value="1" />
                                    </div>
                                </th>
    ...
    $(function(){
        ...
        let table = $("#tbl-karyawan").DataTable({
            ...
            columns: [
                ...
                { data: 'nama_karyawan', render: function(data, type, row) {
                    return `
                ...
                { data: 'jabatan', render: function(data, type, row) {
        ...
        $('#formKaryawan').on('submit', function(e) {
            ...
            let url = $('#karyawan_id').val() ? '{{ route("karyawan.update", ":id") }}'.replace(':id', $('#karyawan_id').val()) : '{{ route("karyawan.store") }}';
        ...
        window.toggleStatus = function(id) {
             $.post('{{ route("karyawan.toggle", ":id") }}'.replace(':id', id), { _token: '{{ csrf_token() }}' }, function(response) {
                table.ajax.reload();
        ...
        // Reset Modal
        $('#modalTambahKaryawan').on('hidden.bs.modal', function() { resetModal(); });
    });
