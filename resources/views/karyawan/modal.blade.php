            ...
            <form id="formKaryawan" action="{{ route('karyawan.store') }}" method="POST" enctype="multipart/form-data">
                ...
                <div class="modal-body scroll-y px-10 px-lg-15 pt-0 pb-15">
                    <div class="mb-13 text-center">
                        ...
                        <div class="text-muted fw-semibold fs-5">Formulir manajemen data karyawan (Perawat, Bidan,
                            Staff)</div>
                    </div>
                    ...
                    <div class="row g-9 mb-8">
                        <div class="col-md-12 text-center mb-5">
                            ...
                            <div class="image-input image-input-outline" data-kt-image-input="true"
                                ...
                                <div class="image-input-wrapper w-125px h-125px" id="preview-foto"
                        ...
                        <div class="col-md-6 fv-row">
                            <label class="fs-6 fw-semibold mb-2">NIP / Kode Pegawai</label>
                            <input type="text" class="form-control form-control-solid" placeholder="Otomatis"
                                name="nip" id="nip" readonly />
                        </div>
                        <div class="col-md-6 fv-row">
                            <label class="required fs-6 fw-semibold mb-2">Nama Lengkap</label>
                            <input type="text" class="form-control form-control-solid" placeholder="Nama Karyawan"
                                name="nama_karyawan" id="nama_karyawan" required />
                        </div>
                    </div>
                    ...
                    <div class="row g-9 mb-8">
                        ...
                        <div class="col-md-6 fv-row">
                            ...
                            <input type="text" class="form-control form-control-solid"
                                placeholder="Misal: Perawat Pelaksana" name="jabatan" id="jabatan" required />
                        </div>
                    </div>
                    ...
                    <div class="row g-9 mb-8">
                        <div class="col-md-6 fv-row">
                            ...
                            <input type="text" class="form-control form-control-solid"
                                placeholder="Misal: Rawat Inap, IGD" name="bagian" id="bagian" required />
                        </div>
                        <div class="col-md-6 fv-row">
                    ...
                    <div id="user-account-section"
                        ...
                        <div class="mb-2 text-muted fs-7">Wajib diisi untuk karyawan baru agar bisa login ke sistem.
                        </div>
                        <div class="row g-9">
                            <div class="col-md-6 fv-row">
