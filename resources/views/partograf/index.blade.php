                ...
                <div class="card-header border-0 pt-6">
                    ...
                    <div class="card-toolbar">
                        <div class="d-flex justify-content-end gap-2" data-kt-subscription-table-toolbar="base">
                            ...
                            <!--end::Filter-->
                            <!--begin::Date Filter-->
                            <input type="date" class="form-control form-control-solid w-150px" 
                                   id="filterDate" placeholder="Filter Tanggal">
                            <!--end::Date Filter-->
                        </div>
                    </div>
                </div>
                        ...
                        <tbody class="text-gray-600 fw-semibold">
                            ...
                            <tr>
                                ...
                                <td class="text-center">
                                    @if($labor->is_action)
                                        <span class="alert-indicator alert-danger" 
                                              data-bs-toggle="tooltip" title="Garis bertindak!"></span>
                                    @elseif($labor->is_alert)
                                        <span class="alert-indicator alert-warning" 
                                              data-bs-toggle="tooltip" title="Garis waspada"></span>
                                    @else
                                ...
                                <td class="text-end">
                                    ...
                                    <div class="menu menu-sub menu-sub-dropdown menu-column menu-rounded menu-gray-600 menu-state-bg-light-primary fw-semibold fs-7 w-200px py-4" 
                                        ...
                                        <div class="menu-item px-3">
                                            <a href="{{ route('partograf.show', $labor->id) }}" class="menu-link px-3">
                                                <i class="fas fa-eye me-2"></i> Lihat Monitoring
                                            </a>
                                        </div>
                                        <div class="menu-item px-3">
                                            <a href="{{ route('partograf.edit', $labor->id) }}" class="menu-link px-3">
                                                <i class="fas fa-edit me-2"></i> Edit Data
                                            </a>
                                        </div>
                                        <div class="menu-item px-3">
                                            <a href="{{ route('partograf.pdf', $labor->id) }}" class="menu-link px-3" target="_blank">
                                        ...
                                        <div class="menu-item px-3">
                                            <form action="{{ route('partograf.destroy', $labor->id) }}" method="POST" 
