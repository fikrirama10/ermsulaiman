        ...
        <div id="kt_app_content" class="app-content flex-column-fluid">
            <div id="kt_app_content_container" class="app-container container-fluid">
                <div class="row g-7">
                    ...
                    <div class="col-lg-8">
                        <form action="{{ route('pasien.update-kunjungan', $rawat->id) }}" method="post"
                            ...
                            <div class="card shadow-sm mb-5" id="tambah_kunjungan">
                                <div class="card-header pt-6">
                                    <h3 class="card-title fw-bold">Edit Kunjungan</h3>
                                </div>
                                <div class="card-body">
                                    <div class="row mb-5">
                                        <div class="col-md-6">
                                            <div class="fv-row mb-4">
                                                ...
                                                <div class="position-relative d-flex align-items-center">
                                                    ...
                                                    <input class="form-control form-control-solid ps-12 flatpickr-input"
                                                        ...
                                                        value="{{ date('Y-m-d', strtotime($rawat->tglmasuk)) }}" />
                                                </div>
                                            </div>
                                        </div>
                                        <div class="col-md-6">
                                            <div class="fv-row mb-4">
                                                ...
                                                <select name="penanggung" class="form-select form-select-solid"
                                                    ...
                                                    <option value="2" {{ $rawat->idbayar == 2 ? 'selected' : '' }}>
                                                        BPJS Kesehatan</option>
                                                    <option value="1" {{ $rawat->idbayar == 1 ? 'selected' : '' }}>
                                                        UMUM / Pribadi</option>
                                                </select>
                                                <div
                                                    ...
                                                    @if ($rawat->no_sep)
                                                        <div
                                                            class="alert alert-success d-flex align-items-center p-2 w-100 mb-0">
                                                            <i class="ki-outline ki-file-added fs-2 text-success me-2"></i>
                                                            <div class="d-flex flex-column">
                                                                <span class="fw-bold">SEP: {{ $rawat->no_sep }}</span>
                                                            </div>
                                                        </div>
                                                    @else
                                            ...
                                            <div class="fv-row mb-4">
                                                ...
                                                <select name="cara_datang" class="form-select form-select-solid"
                                                    ...
                                                    <option value="Datang Sendiri"
                                                        {{ $rawat->cara_datang == 'Datang Sendiri' ? 'selected' : '' }}>
                                                        Datang Sendiri</option>
                                                    <option value="Diantar Keluarga"
                                                        {{ $rawat->cara_datang == 'Diantar Keluarga' ? 'selected' : '' }}>
                                                        Diantar Keluarga</option>
                                                    <option value="Diantar Polisi"
                                                        {{ $rawat->cara_datang == 'Diantar Polisi' ? 'selected' : '' }}>
                                                        Diantar Polisi</option>
                                                    <option value="Ambulans"
                                                        {{ $rawat->cara_datang == 'Ambulans' ? 'selected' : '' }}>Ambulans
                                                    </option>
                                                    <option value="Rujukan"
                                                        {{ $rawat->cara_datang == 'Rujukan' ? 'selected' : '' }}>Rujukan
                                                    </option>
                                                </select>
                                            </div>
                                        </div>
                                    ...
                                    <div class="fv-row mb-4">
                                        ...
                                        <div class="input-group">
                                            ...
                                            <input type="text" name='dokter' id='dokter' readonly
                                                ...
                                                value="{{ $rawat->dokter->nama_dokter ?? $rawat->nama_dokter }}">
...
@section('js')
    ...
    <script>
        ...
        $(document).ready(function() {
            ...
            // Pre-select Unit and Poli
            $('#jenis_rawat').val('{{ $rawat->idjenisrawat }}').trigger('change');
            // Timeout to allow options to populate
            setTimeout(() => {
                $('#poli').val('{{ $rawat->idpoli }}');
                // Re-enable Cari Dokter button if valid
                if ($('#poli').val() > 0) $('#btn-cari-dokter').prop('disabled', false);
            }, 100);
        });
