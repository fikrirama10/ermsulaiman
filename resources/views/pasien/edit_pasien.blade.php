    ...
    <div class="d-flex flex-column flex-column-fluid">
                ...
                <div class="app-toolbar-wrapper d-flex flex-stack flex-wrap gap-4 w-100">
                    <div class="page-title d-flex flex-column justify-content-center gap-1 me-3">
                        ...
                        <ul class="breadcrumb breadcrumb-separatorless fw-semibold fs-7 my-0">
                            ...
                            <li class="breadcrumb-item text-muted">Edit Pasien</li>
                            <li class="breadcrumb-item"><span class="bullet bg-gray-400 w-5px h-2px"></span></li>
                            <li class="breadcrumb-item text-dark">{{ $pasien->nama_pasien }}</li>
                        </ul>
                    </div>
                </div>
            </div>
        ...
        <div id="kt_app_content" class="app-content flex-column-fluid">
            <div id="kt_app_content_container" class="app-container container-fluid">
                ...
                <form method="POST" id="form-create" action="{{ route('pasien.update', $pasien->id) }}">
                    @csrf
                    @method('PUT')
                            ...
                            <div class="card modern-card h-100">
                                <div class="card-header">
                                    <div class="card-title">
                                        <span class="card-icon"><i class="bi bi-pencil-square fs-3"></i></span>
                                        <span class="d-flex flex-column">
                                            <span class="fw-bold fs-7">Edit Data Pasien</span>
                                            <span class="text-muted fs-8 fw-normal">Perbaharui data pasien jika ada
                                                perubahan</span>
                                        </span>
                                    </div>
                                </div>
                                ...
                                <div class="card-body d-flex flex-row justify-content-between align-items-center p-4">
                                    <div>
                                        <span class="text-gray-600 fs-8 fw-bold text-uppercase d-block mb-1">No. Rekam
                                            Medis</span>
                                        <h2 class="text-primary fs-2 fw-bolder m-0" id="display-rm">
                                            {{ $pasien->kodepasien }}</h2>
                                    </div>
                                    <input type="hidden" name='no_rm' value="{{ $pasien->kodepasien }}"
                                        id='pasien-kodepasien' required />
                                </div>
                            </div>
                        </div>
                    </div>
                        ...
                        <div class="card-body">
                            <div class="row g-3 mb-3">
                                <div class="col-md-6">
                                    ...
                                    <input type="text" name="nama_pasien" id="nama_pasien"
                                        value="{{ $pasien->nama_pasien }}" class="form-control form-control-sm"
                            ...
                            <div class="row g-3 mb-3">
                                <div class="col-md-4">
                                    ...
                                    <input type="text" name="tempat_lahir" value="{{ $pasien->tempat_lahir }}"
                                        class="form-control form-control-sm" placeholder="Kota Kelahiran" required />
                                </div>
                                <div class="col-md-4">
                                    <label class="form-label required">Tanggal Lahir</label>
                                    <input class="form-control form-control-sm" name="tgl_lahir" id="tgl_lahir"
                                        value="{{ $pasien->tgllahir }}" placeholder="YYYY-MM-DD" required />
                                </div>
                                <div class="col-md-4">
                                    ...
                                    <select name="golongan_darah" class="form-select form-select-sm" required>
                                        ...
                                        @foreach ($gol_darah as $gl)
                                            <option value="{{ $gl->id }}"
                                                {{ $pasien->idgolongan_darah == $gl->id ? 'selected' : '' }}>
                                                {{ $gl->golongan_darah }}</option>
                                        @endforeach
                                    </select>
                                </div>
                            </div>
                            ...
                            <div class="row g-3 mb-3">
                                <div class="col-md-6">
                                    ...
                                    <input type="text" name="no_hp" id="no_hp" value="{{ $pasien->nohp }}"
                                        class="form-control form-control-sm" placeholder="Contoh: 081234567890"
                                        required />
                                </div>
                                <div class="col-md-6">
                                    <label class="form-label required">Email</label>
                                    <input type="email" name="email" id="email" value="{{ $pasien->email }}"
                            ...
                            <div class="row">
                                <div class="col-md-12">
                                    ...
                                    <textarea name="alamat" id="alamat" class="form-control form-control-sm" rows="2"
                                        placeholder="Nama Jalan, No. Rumah, RT/RW" required>{{ $pasien->alamat->alamat ?? '' }}</textarea>
                                </div>
                            </div>
                                    ...
                                    <div class="mb-3">
                                        ...
                                        <select name="id_pendidikan" class="form-select form-select-sm"
                                            ...
                                            @foreach ($data_pendidikan as $dp)
                                                <option value="{{ $dp->id }}"
                                                    {{ $pasien->idpendidikan == $dp->id ? 'selected' : '' }}>
                                    ...
                                    <div class="mb-3">
                                        ...
                                        <select name="id_hubungan_pernikakan" class="form-select form-select-sm"
                                            ...
                                            @foreach ($data_hubungan as $dh)
                                                <option value="{{ $dh->id }}"
                                                    {{ $pasien->idhubungan == $dh->id ? 'selected' : '' }}>
                                                    {{ $dh->hubungan }}</option>
                                            @endforeach
                                        </select>
                                    </div>
                                ...
                                <div class="card-body">
                                    <div class="mb-3">
                                        ...
                                        <select name="id_pekerjaan" class="form-select form-select-sm"
                                            ...
                                            @foreach ($data_pekerjaan as $dp)
                                                <option value="{{ $dp->id }}"
                                                    {{ $pasien->idpekerjaan == $dp->id ? 'selected' : '' }}>
                                                    {{ $dp->pekerjaan }}</option>
                                            @endforeach
                                        </select>
                                    </div>
                                    <div class="row g-2 mb-3">
                                        <div class="col-md-6">
                                            ...
                                            <input type="text" name="nrp" value="{{ $pasien->nrp }}"
                                                class="form-control form-control-sm" placeholder="Opsional" />
                                        </div>
                                        <div class="col-md-6">
                                            <label class="form-label">Pangkat</label>
                                            <input type="text" name="pangkat" value="{{ $pasien->pangkat }}"
                                                class="form-control form-control-sm" placeholder="Opsional" />
                                        </div>
                                    </div>
                                    <div class="mb-3">
                                        <label class="form-label">Kesatuan / Instansi</label>
                                        <input type="text" name="kesatuan" value="{{ $pasien->kesatuan }}"
                                            class="form-control form-control-sm" placeholder="Opsional" />
                                    </div>
                                    <div class="mb-3">
                                        ...
                                        <div class="input-group input-group-sm">
                                            <select name="status_pasien" class="form-select form-select-sm" required>
                                                @foreach ($data_status as $ds)
                                                    <option value="{{ $ds->id }}"
                                                        {{ $pasien->status_pasien == $ds->id ? 'selected' : '' }}>
                                                        {{ $ds->d_status }}</option>
                                                @endforeach
                                            </select>
                                        </div>
                            ...
                            <div class="row g-3 mb-3">
                                <div class="col-md-6">
                                    ...
                                    <input type="text" name="penanggung_jawab"
                                        value="{{ $pasien->penanggung_jawab }}" class="form-control form-control-sm"
                                        required />
                                </div>
                                <div class="col-md-6">
                                    ...
                                    <select name="hubungan" class="form-select form-select-sm"
                                        ...
                                        @foreach ($pasien_penanggungjawab as $dh)
                                            <option value="{{ $dh->id }}"
                                                {{ $pasien->idsb_penanggungjawab == $dh->id ? 'selected' : '' }}>
                                                {{ $dh->penaggungjawab }}</option>
                                        @endforeach
                                    </select>
                                </div>
                            </div>
                            <div class="row g-3">
                                <div class="col-md-6">
                                    ...
                                    <input type="text" name="no_tlp_penanggung_jawab"
                                        value="{{ $pasien->nohp_penanggungjawab }}" class="form-control form-control-sm"
                                        required />
                                </div>
                                <div class="col-md-6">
                                    <label class="form-label required">Alamat Penanggung Jawab</label>
                                    <input type="text" name="alamat_penanggung_jawab"
                                        value="{{ $pasien->alamat_penanggunjawab }}" class="form-control form-control-sm"
                                        required />
                                </div>
                            </div>
                        </div>
                    ...
                    <div class="action-bar">
                        <a href="{{ route('pasien.rekammedis_detail', $pasien->id) }}"
                            class="btn btn-light btn-active-light-primary">Batal</a>
                        <button type="button" id='button-tambah' class="btn btn-primary">
                            <i class="bi bi-save me-1"></i> Perbaharui Data
                        </button>
                    </div>
