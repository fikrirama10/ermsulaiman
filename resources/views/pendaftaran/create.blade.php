                ...
                <div class="page-title d-flex flex-column justify-content-center gap-1 me-3">
                    ...
                    <ul class="breadcrumb breadcrumb-separatorless fw-semibold fs-7 my-0">
                        <li class="breadcrumb-item text-muted">
                            <a href="{{ route('pendaftaran.index') }}" class="text-muted text-hover-primary">Pendaftaran</a>
                        </li>
                        ...
                        <div class="row justify-content-center">
                            <div class="col-lg-8">
                                ...
                                <div class="text-center mt-5">
                                    ...
                                    <a href="{{ route('pasien.tambah-pasien') }}" class="fw-bold text-primary ms-1">Buat Pasien Baru</a>
                                </div>
                            </div>
                        </div>
                    </div>
                    ...
                    <div id="step2-content" class="d-none">
                        <form action="{{ route('pendaftaran.store') }}" method="POST" id="formPendaftaran">
                            ...
                            <div class="alert alert-primary d-flex align-items-center p-5 mb-10">
                                ...
                                <button type="button" class="btn btn-sm btn-icon btn-light-primary ms-auto" onclick="resetStep1()" title="Ganti Pasien">
                            ...
                            <div class="row g-5 mb-10">
                                <div class="col-md-4">
                                    <div class="card shadow-none bg-light service-card selected" onclick="selectService(1)" id="card_rj">
                                ...
                                <div class="col-md-4">
                                    <div class="card shadow-none bg-light service-card" onclick="selectService(3)" id="card_igd">
                                        <div class="card-body text-center py-5">
                                ...
                                <div class="col-md-4">
                                    <div class="card shadow-none bg-light service-card" onclick="selectService(2)" id="card_ri">
                                        <div class="card-body text-center py-5">
                                            <i class="fas fa-procédure fs-1 text-warning mb-3"></i> <!-- procdure icon? using bed icon if fail -->
                            ...
                            <div class="row mb-5">
                                ...
                                <div class="col-md-6 mb-5 d-none" id="group_ruangan">
                                    ...
                                    <select class="form-select form-select-solid" name="idruangan" id="select_ruangan">
                                        <option value="">-- Pilih Ruangan --</option>
                                        @foreach($ruangan as $r)
                                            <option value="{{ $r->id }}">{{ $r->nama_ruangan }} (Kelas {{ $r->idkelas }})</option>
                                        @endforeach
                                    </select>
                                </div>
                                ...
                                <div class="col-md-6 mb-5">
                                    ...
                                    <div class="form-text" id="dokter_helper">Pilih Poli terlebih dahulu untuk filter dokter.</div>
                                </div>
                                ...
                                <div class="col-md-6 mb-5">
                                     ...
                                     <input type="date" class="form-control form-control-solid" name="tglmasuk" value="{{ date('Y-m-d') }}">
                                </div>
                            </div>
                ...
                success: function(res) {
                    ...
                    if(res.length > 0) {
                        ...
                        $('#search_results').html(html).removeClass('d-none');
                         ...
                         $('#search_results').html('<div class="list-group-item text-muted text-center">Data tidak ditemukan</div>').removeClass('d-none');
                    }
                }
            });
        }, 500);
