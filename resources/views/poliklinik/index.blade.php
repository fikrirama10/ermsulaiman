                ...
                <div class="card">
                    ...
                    <div class="card-body p-lg-15">
                        <table id="tbl-pasien" class="table table-striped table-row-bordered gy-5 gs-7 border rounded">
                            <thead
                                class="table  align-middle table-rounded table-hover table-bordered table-bordered-bottom border-gray-500 fs-6">
                                <tr class="text-dark text-nowrap fw-bold fs-7 text-uppercase">
                                    <th>No RM</th>
                                    <th>Nama Pasien</th>
                                    <th>Tgl.Masuk</th>
                                    <th>Poli</th>
                            ...
                            <tbody class="text-gray-600 text-nowrap fs-7 fw-semibold dataTables_scrollBody">
            ...
            $("#tbl-pasien").DataTable({
                ...
                columns: [{
                    ...
                    },
                    {
                        ...
                        name: 'poli.poli',
                        render: function(data, type, row) {
                            return `<span class="badge badge-light-success fs-7">${data}</span> <span class="badge badge-light fs-7">${row.jenis}</span><br> ${row.nama_dokter}`;
